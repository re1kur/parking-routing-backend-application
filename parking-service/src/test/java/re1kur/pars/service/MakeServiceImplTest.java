...
class MakeServiceImplTest {
    ...
    void create__ReturnsMakeDto() {
        ...
        MakeDto result = assertDoesNotThrow(() -> service.create(payload));
    ...
    void create__MakeAlreadyExists__ThrowsException() {
        ...
        assertThrows(MakeAlreadyExistsException.class, () -> service.create(payload));
    ...
    void update__ReturnsMakeDto() {
        ...
        MakeDto result = assertDoesNotThrow(() -> service.update(payload, makeId));
    ...
    void update__MakeNotFound__ThrowsException() {
        ...
        assertThrows(MakeNotFoundException.class, () -> service.update(payload, makeId));
    ...
    void update__NameAlreadyExists__ThrowsException() {
        ...
        assertThrows(MakeAlreadyExistsException.class, () -> service.update(payload, makeId));
    ...
    void delete__DeletesMake() {
        ...
        assertDoesNotThrow(() -> service.delete(makeId));
    ...
    void delete__MakeNotFound__ThrowsException() {
        ...
        assertThrows(MakeNotFoundException.class, () -> service.delete(makeId));
