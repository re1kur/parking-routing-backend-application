...
//        when(service.create(MakePayload.builder()
//                .name("make")
//                .build(), bearer)).thenThrow(MakeAlreadyExistsException.class);
//
//        mvc.perform(post(URL + "/create")
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .content(mapper.writeValueAsString(payload)))
...
//                .name("newName")
//                .build(), 1, bearer)).thenReturn(MakeDto.builder()
//                .name("newName")
//                .build());
//
...
//                .andExpect(content().json(mapper.writeValueAsString(expected)));
//
//        verify(service, times(1)).update(payload, makeId, bearer);
//    }
//
//    @Test
...
//        when(service.update(MakePayload.builder()
//                .name("newName")
//                .build(), 1, bearer)).thenThrow(MakeNotFoundException.class);
//
//        mvc.perform(put(URL + "/%d/update".formatted(makeId))
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .content(mapper.writeValueAsString(payload)))
...
//        when(service.update(MakePayload.builder()
//                .name("newName")
//                .build(), 1, bearer)).thenThrow(MakeAlreadyExistsException.class);
//
//        mvc.perform(put(URL + "/%d/update".formatted(makeId))
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .content(mapper.writeValueAsString(payload)))
...
//        Integer makeId = 1;
//
//        doNothing().when(service).delete(1, bearer);
//
...
//        Integer makeId = 1;
//
//        doThrow(MakeNotFoundException.class).when(service).delete(1, bearer);
//
//        mvc.perform(delete(URL + "/%d/delete".formatted(makeId)))
//                .andExpect(status().isBadRequest());
//
